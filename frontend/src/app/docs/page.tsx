    ...
    return (
        <div className="min-h-screen bg-[#0b0b0d] text-white">
            ...
            <main className="max-w-3xl mx-auto px-6 py-16">
                ...
                <p className="text-white/55 mb-12 leading-relaxed rounded-xl surface-card p-5">
                ...
                <section className="mb-14">
                    ...
                    <div className="space-y-6">
                        {NODES.map((node) => (
                            <div key={node.name} className="rounded-xl surface-card p-5">
                                <h3 className="text-lg font-semibold text-white mb-1.5">{node.name}</h3>
                                <p className="text-sm text-white/55 mb-4 leading-relaxed">{node.summary}</p>
                ...
                <section className="mb-14">
                    ...
                    <div className="rounded-xl surface-card divide-y divide-white/10 mb-4">
                ...
                <section className="mb-14">
                    ...
                    <p className="text-white/60 mt-4 leading-relaxed">
                        Running the whole stack locally with <Code>netlify dev</Code> (see the Quickstart in the root README)?
                        You don&apos;t need a tunnel at all. A Request node can point straight at{' '}
                        <Code>{'http://localhost:{your-port}'}</Code>, since the proxy function is running on the same machine
                        as your API in that mode. Tunnels are only needed once your workflow is actually deployed to the cloud.
                    </p>
                </section>
