...
const NODES = [
    {
        name: 'Request',
        summary: 'Defines the HTTP method and path that triggers the workflow — every workflow starts with exactly one.',
        fields: [
    ...
    },
    {
        ...
        fields: [
            ...
            ['Value', 'Needed for type / regex / min / max — e.g. "string" or ^[^@]+@[^@]+$'],
    ...
    {
        name: 'Conditional',
        summary: 'Branches the workflow with a safe expression evaluator — not full JavaScript, so there are no function calls like .includes().',
        fields: [
...
export default function DocsPage() {
                    ...
                    <ol className="space-y-4">
                        ...
                        <li className="flex gap-3">
                            ...
                            <p className="text-indigo-200/70">
                                ...
                                production traffic — no deploy required to iterate.
                            </p>
                        </li>
                        <li className="flex gap-3">
  ...
  "views": "{{state.count}}"
                ...
                <section className="mb-14">
                    ...
                    <Pre>{`https://mockito.netlify.app/api/{workspace}/{path}`}</Pre>
